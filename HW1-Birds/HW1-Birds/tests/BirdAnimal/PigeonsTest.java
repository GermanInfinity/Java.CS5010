...
/**
 * A JUnit test class for the Pigeons class.
 * 
 */
public class PigeonsTest {
  ...
  public void setup() {
    ...
    Characlist.add("Feed young bird milk");

    ArrayList<String> Foodlist = new ArrayList<String>();
    Foodlist.add("buds");
    Foodlist.add("larvae");

    test = new Pigeons("Pigeons", Characlist, false, 0, Foodlist);
  }
  ...
  public void testgetType() {
    assertEquals("Pigeons", test.getType());
  }
  ...
  public void testaddCharac() {
    test.addCharac("Small heads");

    ArrayList<String> CharaclistTest = new ArrayList<String>();
    CharaclistTest.add("Feed young bird milk");
    CharaclistTest.add("Small heads");
  ...
  public void testaddSameCharac() {
    test.addCharac("Feed young bird milk");
  }
  ...
  public void testremoveCharac() {
    ...
    test = new Pigeons("Pigeons", Characlist, false, 0, Foodlist);
    test.removeCharac("Feed young bird milk");

    ArrayList<String> CharaclistTest2 = new ArrayList<String>();
    CharaclistTest2.add("Small heads");
    assertTrue("Both character lists are not equal", 
  ...
  public void testsetType() {
    test.setType("Doves");
    assertEquals("Doves", test.TypeOfBird);
  }
  ...
  public void testInvalidBirdType() {
    ...
    test = new Pigeons("Hawk", Characlist, false, 0, Foodlist);
  ...
  public void testNegNumOfWings() {
    ...
    test = new Pigeons("Pigeons", Characlist, false, -89, Foodlist);
  }
  ...
  public void testMaxNumOfWings() {
    ...
    test = new Pigeons("Pigeons", Characlist, false, 3, Foodlist);
  }
  ...
  public void testSetnegNumOfWings() {
    ...
    test = new Pigeons("Pigeons", Characlist, false, 2, Foodlist);
    test.setWingsNum(-1);
  }

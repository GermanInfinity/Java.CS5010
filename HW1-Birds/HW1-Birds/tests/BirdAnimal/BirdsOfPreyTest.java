...
public class BirdsOfPreyTest {
  ...
  {
    String expectedOutput = "Type: Hawks, Characteristics: [Sharp beaks], Is Extinct: false, Wing numbers: 2, Food preference: [buds, larvae]";
    ...
    assertEquals(2, test.WingsNum, 0);
  ...
  public void testtoString() { 
    ...
    test = new BirdsOfPrey("Eagles", Characlist, false, 2, Foodlist);
    String expectedOutput = "Type: Eagles, Characteristics: [Sharp beaks], Is Extinct: false, Wing numbers: 2, Food preference: [fish, buds]";
    assertEquals(expectedOutput, test.toString());
  }
  ...
  { 
    assertEquals(2, test.getNumOfWings(), 0);
  }
  ...
  { 
    test.setType("Eagles");
    assertEquals("Eagles", test.getType());
  }
  ...
  public void testInvalidBirdType() 
  {
    ...
    test = new BirdsOfPrey("Tiger", Characlist, false, 0, Foodlist);

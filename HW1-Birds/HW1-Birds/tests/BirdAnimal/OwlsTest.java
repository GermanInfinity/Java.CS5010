...
/**
 * A JUnit test class for the Owls class.
 * 
 */
public class OwlsTest {
  ...
  public void setup() {
    ...
    Characlist.add("Facial disk");

    ArrayList<String> Foodlist = new ArrayList<String>();
    Foodlist.add("buds");
    Foodlist.add("larvae");

    test = new Owls("Owls", Characlist, false, 0, Foodlist);
  }
  ...
  public void testInputs() {
    ...
    assertEquals("Owls", test.TypeOfBird);
  ...
  public void testgetType() {
    assertEquals("Owls", test.getType());
  }
  ...
  public void testsetType() {
    test.setType("True owl");
    assertEquals("True owl", test.TypeOfBird);
  }
  ...
  public void testNegNumOfWings() {
    ...
    test = new Owls("Owls", Characlist, false, -89, Foodlist);
  }
  ...
  public void testMaxNumOfWings() {
    ...
    test = new Owls("Owls", Characlist, false, 3, Foodlist);
  }
  ...
  public void testSetnegNumOfWings() {
    ...
    test = new Owls("Owls", Characlist, false, 2, Foodlist);
    test.setWingsNum(-1);
  }

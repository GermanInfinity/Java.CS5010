...
public class Shorebirds extends Birds {
  ...
  private String[] Flightless_Bird_Types = {"Great auk", "Horned puffin", "African Jacana"};
   ...
   * 
   */
  public Shorebirds(String birdType, ArrayList<String> characList, Boolean extinct, 

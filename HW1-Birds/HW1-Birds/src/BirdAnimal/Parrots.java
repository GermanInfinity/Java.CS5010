...
public class Parrots extends Birds {
  ...
  private String[] ParrotTypes = {"Rose-ringed parakeet", "Gray parrot", "Sulfur-crested cockatoo"};
   ...
   * 
   */
  public Parrots(String birdType, ArrayList<String> characList, Boolean extinct, 
  ...
  /**
   * Set's the type of a Parrots bird. 
  ...
  protected void setType(String birdType) 
  {
    ...
    if (Arrays.asList(ParrotTypes).contains(birdType) == false) {
      throw new IllegalArgumentException(
          birdType + " is not a Parrots Bird.");
    }
    this.TypeOfBird = birdType; 
  }
  ...
  /**
   * Set's the characteristic of a Parrots bird. 
  ...
  /**
   * Adds the characteristic of a Parrots bird. 
  ...
  protected void addCharac(String charac)
  {
    ...
    if (Arrays.asList(Bird_CharacList).contains(charac) == false){
      throw new IllegalArgumentException(
          charac + " is not a Parrots Bird characteristic.");
    } 
  ...
  /**
   * Remove a characteristic of a Parrots bird. 
   * Accepts a strings and returns nothing. 
   * 
   */
  @Override

...
public class Aviary {
  ...
  /** 
   * Constructor of an Aviary class. Creates an object that stores 5 bird objects. 
  ...
  { 
    ...
    String name = ""; 
    if (ClassOfBird(birdName) == "Birds of Prey") { name = "Roofvogels " + this.num; }; 
    if (ClassOfBird(birdName) == "Flightless Birds") { name = "Loopvogels " + this.num; }; 
    if (ClassOfBird(birdName) == "Owls") { name = "Uilen " + this.num; }; 
    if (ClassOfBird(birdName) == "Parrots") { name = "Papegaaien " + this.num; }; 
    if (ClassOfBird(birdName) == "Pigeons") { name = "Duiven " + this.num; }; 
    if (ClassOfBird(birdName) == "Shorebirds") { name = "Kustvogels " + this.num; }; 
    if (ClassOfBird(birdName) == "Waterfowl") { name = "Watervogels " + this.num; }; 
  ...
  public String ClassOfBird(String birdName)
  {
    ...
    if (BirdsOfPreyList.contains(birdName)) { return ("Birds Of Prey"); } ;
    ...
    if (FlightlessBirdsList.contains(birdName)) { return "Flightless Birds"; } ;
    ...
    if (ParrotsList.contains(birdName)) { return "Parrots"; } ;
    ...
    if (PigeonsList.contains(birdName)) { return "Pigeons"; } ;
    ...
    if (ShorebirdsList.contains(birdName)) { return "Shorebirds"; } ;
